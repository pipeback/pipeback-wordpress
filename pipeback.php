...
add_action('wp_head', 'pipeback_inject_script');

function pipeback_inject_script()
{
    static $loaded = false;
    if ($loaded) {
        return; // já carregado
    ...
    echo 'window.$pipeback = window.$pipeback || [];';
    echo 'window.PIPEBACK_ID = "' . esc_js($workspace_id) . '";';
    echo '(function(){ var d=document,s=d.createElement("script");s.src="https://widget.pipeback.com/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();';
    echo '</script>';
}
